...
// const API_GET_DATA = "https://api.digitalvidyasaarthi.in/api/v1/adminRoute/getAllStudents"
const ParentHome = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://api.digitalvidyasaarthi.in/api/v1/adminRoute/getAllStudents?email=${email}`,
      {

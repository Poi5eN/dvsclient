...
//           // console.log(data)
//             axios.delete(`https://api.digitalvidyasaarthi.in/api/v1/events/deleteEvent/${data._id}`, 
//           {
...
//     try {
//       const response = await axios.get('https://api.digitalvidyasaarthi.in/api/v1/events/getAllEvents', {
//         withCredentials: true,
//           headers: {
//             Authorization: `Bearer ${authToken}`,
//           },
...
//       axios.post('https://api.digitalvidyasaarthi.in/api/v1/events/createEvent', {
//         updatedData
//       }, {
//         withCredentials: true,
//       headers: {

          ...
          <div key={student.studentId || `student-print-${index}`} className="print-id-card">
            ...
            <div className="print-card-details-section">
              ...
              <p>
                ...
                <span className="detail-value ml-1">{student?.class && student?.section ? `${student.class}-${student.section}` : "N/A"}</span>
              </p>
              <p>
...
//                 <p><strong>Photo No:</strong> {student?.photoNo || 'N/A'}</p>
//                 <p><strong>Name:</strong> {student?.studentName || 'N/A'}</p>
//                 <p><strong>Class:</strong> {student?.class && student?.section ? `${student.class}-${student.section}` : 'N/A'}</p>
//                 <p><strong>Father:</strong> {student?.udisePlusDetails?.father_name || 'N/A'}</p>
//                 <p><strong>DOB:</strong> {student?.dateOfBirth ? moment(student.dateOfBirth).format("DD-MM-YY") : 'N/A'}</p>
//               </div>
//             </div>
...
//               <p><strong>Class:</strong> {student?.class && student?.section ? `${student.class}-${student.section}` : 'N/A'}</p>
//               <p><strong>Father:</strong> {student?.udisePlusDetails?.father_name || 'N/A'}</p>
//               <p><strong>DOB:</strong> {student?.dateOfBirth ? moment(student.dateOfBirth).format("DD-MM-YY") : 'N/A'}</p> {/* Shortened DOB format */}
//             </div>
//           </div>
//           <div className="print-id-card-footer">
//             <p className="print-school-address">{schoolDetails?.address || 'School Address'}</p>
...
//               <p><strong>Class:</strong> {student?.class && student?.section ? `${student.class}-${student.section}` : 'N/A'}</p>
//               <p><strong>Father:</strong> {student?.udisePlusDetails?.father_name || 'N/A'}</p>
//               <p><strong>DOB:</strong> {student?.dateOfBirth ? moment(student.dateOfBirth).format("DD-MMM-YYYY") : 'N/A'}</p>
//             </div>
//           </div>
//           <div className="print-id-card-footer">

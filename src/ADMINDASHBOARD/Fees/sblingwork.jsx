...
const NewCheckFee2 = () => {
  ...
  const handleStudentClick = (admissionNumber) => {
    axios
      .get(
        `https://api.digitalvidyasaarthi.in/api/v1/adminRoute/getParentWithChildren/${admissionNumber}`,
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${authToken}`,
...
//   useEffect(() => {
//     axios
//       .get("https://api.digitalvidyasaarthi.in/api/v1/adminRoute/getAllFees", {
//         withCredentials: true,
//         headers: {
//           Authorization: `Bearer ${authToken}`,
//         },

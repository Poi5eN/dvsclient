...
//   admissionNo: (
//     <span className="uppercase text-indigo-700 font-semibold ">
//       {student.admissionNumber || "N/A"}
//     </span>
//   ),

//   // name: (student.studentName) || "N/A",
//   name: <span className="uppercase  text-deep-purple-500">{student.studentName || "N/A"}</span>,

//   email: <span className="uppercase text-blue-400">{student.email || "N/A"}</span>,
...
//   dateOfBirth: (
//     <span className="uppercase  text-deep-purple-700">
//       {student.dateOfBirth
...
//   contact: <span className="text-cyan-800">{student.contact || "N/A"}</span>,

//   gender: <span className={` ${student.gender==="Male"?"text-blue-800":"text-pink-800"}`}>{student.gender || "N/A"}</span>,
...
// }));
  ...
  const tBody = filteredData?.map((student, ind) => ({
    ...
    // name: student.studentName || "N/A",
     name: (
    <span className="text-cyan-800 uppercase font-semibold ">
  ...
  // ),
    ...
    dateOfBirth: <span className="text-pink-400">{student.dateOfBirth
      ? moment(student.dateOfBirth).format("DD-MMM-YYYY")
      : "N/A"}</span>,
  ...
  if (!isEditing && !studentToView) {
    return (
      <div className="">
         <PageHeaderWithBreadcrumb breadcrumbItems={BreadcrumbList.student} title="Students"/>
...
//   const THEAD = [
//     { id: "SN", label: "S No.", width: "0.1%" },
//     { id: "photo", label: "Photo", width: "5%" },
//     { id: "admissionNo", label: "Adm No", width: "10%" },
//     { id: "name", label: "Name", width: "20%" },
//     { id: "email", label: "Email", width: "20%" },
//     { id: "fatherName", label: "F Name" ,width: "10%" },
//     { id: "class", label: "Class" ,width: "4%" },
//     { id: "dateOfBirth", label: "DOB" ,width: "5%" },
//     { id: "contact", label: "Contact" ,width: "5%" },
//     { id: "gender", label: "Gender" ,width: "5%" },
...
//   name: (student.studentName) || "N/A",
//   // name: <span className=" text-deep-purple-500">{student.studentName || "N/A"}</span>,

//   email: <span className="text-blue-400">{student.email || "N/A"}</span>,

//   fatherName: (
//     <span className="">{student.fatherName || "N/A"}</span>
//   ),
...
//   dateOfBirth: (
//     <span className=" text-deep-purple-700">
//       {student.dateOfBirth
//         ? moment(student.dateOfBirth).format("DD-MMM-YYYY")
//         : "N/A"}
//     </span>

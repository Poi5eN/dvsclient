    ...
    const fetchStudentAndParentData = async (email, authToken) => {
      try {
        const response = await axios.get(
          `https://api.digitalvidyasaarthi.in/api/v1/admin Route/getStudentAndParent/${email}`,
          // `https://api.digitalvidyasaarthi.in/api/v1/adminRoute/getDataByAdmissionNumber/${email}`,
          {
...
//   const schoolAddress = sessionStorage.getItem("schooladdress");
  ...
  //     try {
  //       const response = await axios.get(
  //         `https://api.digitalvidyasaarthi.in/api/v1/adminRoute/getStudentAndParent/${email}`,
  //         // `https://api.digitalvidyasaarthi.in/api/v1/adminRoute/getDataByAdmissionNumber/${email}`,
  //         {
  //           withCredentials: true,
  //           headers: {

...
const IdCard = () => {
    ...
    // ===== THE FIX IS HERE ===================================================
    // =========================================================================
    // We now filter the original `studentData` array. This ensures that even
    // if the user filters the view, all selected students from the master list
    // are found and printed.

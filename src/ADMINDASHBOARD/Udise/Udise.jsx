  ...
  const updateSelectedRows = async () => {
    ...
    try {
      const response = await axios.put(
        "https://api.digitalvidyasaarthi.in/api/v1/adminRoute/bulkUpdateStudents",
        requestBody,
        {
...
//   const { queryData: studentData, error: studentError, loading: studentLoading } = useCustomQuery("https://api.digitalvidyasaarthi.in/api/v1/adminRoute/getAllStudents");

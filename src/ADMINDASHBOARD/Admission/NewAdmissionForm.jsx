...
const Admission_form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://api.digitalvidyasaarthi.in/api/v1/adminRoute/createStudentParent",
        formDataToSend,
        {
  ...
  //      await axios.post("https://api.digitalvidyasaarthi.in/api/v1/adminRoute/createStudentParent", formDataToSend,
  //         {
  //           withCredentials: true,
  //           headers: {
  //             Authorization: `Bearer ${authToken}`,
  ...
  //   try {
  //     const response = await axios.post("https://api.digitalvidyasaarthi.in/api/v1/adminRoute/createStudentParent", payload);
  //     console.log("Form submitted successfully:", response.data);
  //   } catch (error) {
  //     console.error("Error submitting form:", error);
  //   }
...
//     try {
//       const response = await axios.post("https://api.digitalvidyasaarthi.in/api/v1/adminRoute/createStudentParent", formDataToSend, {
//         withCredentials: true,
//         headers: {
//           Authorization: `Bearer ${authToken}`,
//           "Content-Type": "multipart/form-data",

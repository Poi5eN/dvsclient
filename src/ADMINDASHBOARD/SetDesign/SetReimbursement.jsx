...
import { design, getIDcarddesign } from "../../Network/AdminApi";
...
<div style='background-image:url(\${backgroundImage}); background-position: center;background-repeat: no-repeat;width: 210mm;height: 297mm;position: relative;background-size:cover;border:1px solid #ccc; box-sizing: border-box; overflow: hidden;'>
    
   
   
    <div style='position: absolute; left: 220px; top: 350px; width: calc(54mm - 6px); font-family: sans-serif; '>
        <p style='font-size:20px; text-transform: uppercase; margin: 0 0 1px 0; color:"#1a3b51; font-weight: bold; line-height: 1.1;'><span style="margin-left: 0px; font-weight: bold;">\${name}</span></p>
        <p style='font-size:20px; text-transform: uppercase; margin: 15px 0 1px 0; color:"#1a3b51; font-weight: bold; line-height: 1.1;'><span style="margin-left: 49px; font-weight: bold;"> \${father_name}</span></p>
        
        <p style='font-size:20px; text-transform: uppercase; margin: 13px 0 1px 0; color:"#1a3b51; font-weight: bold; line-height: 1.1;'><span style="margin-left: 0px; font-weight: bold;">\${class}</span></p>
          </div>
...
const SetReimbursement = () => {
     ...
     const handleFileChange = (e, side) => {
        ...
        if (file) {
            ...
            reader.readAsDataURL(file);
             ...
             if (side === 'front') setUploadedFrontImageFile(null);
        }
    ...
    const handleSaveClick = async () => {
        ...
        try {
            ...
            formDataToSend.append("name", idCardData?.name || "reimbursement certificate"); // Use fetched name or default
            formDataToSend.append("type", idCardData?.type || "reimbursementForm");
    ...
    return (
        ...
        >
               {/* <div style='position: absolute; left: 220px; top: 450px; width: calc(54mm - 6px); font-family: sans-serif; '>
       <p style='font-size:20px; text-transform: uppercase; margin: 0 0 1px 0; color:"#1a3b51; font-weight: bold; line-height: 1.1;'>Roll No.<span style="margin-left: 9px; font-weight: bold;">: \${rollNo}</span></p>
        <p style='font-size:20px; text-transform: uppercase; margin: 0 0 1px 0; color:"#1a3b51; font-weight: bold; line-height: 1.1;'>PHONE<span style="margin-left: 12px; font-weight: bold;">: \${mobile}</span></p>
        <p style='font-size:20px; text-transform: uppercase; margin: 0 0 1px 0; color:"#1a3b51; font-weight: bold; line-height: 1.1;'>DOB<span style="margin-left: 12px; font-weight: bold;">: \${dob}</span></p>
        <p style='font-size:20px; text-transform: uppercase; margin: 0; color:"#1a3b51; font-weight: bold; line-height: 1.2;'>ADDRESS<span style="margin-left: 1px; font-weight: bold;">: \${address}</span></p>
    </div> */}
            <div 
        
             className="bg-white p-2 rounded-lg shadow border border-gray-200 grid sm:grid-cols-1 md:grid-cols-1 gap-2"
            >
...
export default SetReimbursement;
...
const EditPrimary = lazy(() =>
  import("./ADMINDASHBOARD/Classes/EditClass")
);
...
const ReportCardteacher = lazy(() =>
  import("./TEACHERDASHBOARD/NewExam/ReportCard")
);
const AdmitCardTeacher = lazy(() =>
  import("./TEACHERDASHBOARD/NewExam/AdmitCard")
);
const Fees = lazy(() => import("./ADMINDASHBOARD/Fees/Fees"));
const Thirdparty = lazy(() =>
  import("./ADMINDASHBOARD/NewRegistration/Thirdparty")
);
const Admin = lazy(() =>
  import("./ShikshMitraWebsite/component/LoginPage/Admin")
);
const Receptionist = lazy(() =>
  import("./ShikshMitraWebsite/component/LoginPage/Receptionist")
);
const Thirdpartylogin = lazy(() =>
  import("./ShikshMitraWebsite/component/LoginPage/Thirdparty")
);
const Accountants = lazy(() =>
  import("./ShikshMitraWebsite/component/LoginPage/Accountants")
);
const StudentLogin = lazy(() =>
  import("./ShikshMitraWebsite/component/LoginPage/Student")
);
const ParentLogin = lazy(() =>
  import("./ShikshMitraWebsite/component/LoginPage/Parent")
);
const CreateExam = lazy(() => import("./ADMINDASHBOARD/Exams/CreateExam"));
const ThirdPartyDashboard = lazy(() =>
  import("./THIRDPARTY/ThirdPartyDashboard")
);
const ThirdPartyHome = lazy(() => import("./THIRDPARTY/ThirdPartyHome"));
const ThirdPartyMobile = lazy(() =>
  import("./THIRDPARTY/Mobile/ThirdPartyMobile")
);
const Feature = lazy(() =>
  import("./ShikshMitraWebsite/component/New/Feature")
);
const Contact = lazy(() =>
  import("./ShikshMitraWebsite/component/New/Page/Fetaure/Contact/Contact")
);
const About = lazy(() =>
  import("./ShikshMitraWebsite/component/New/Page/About/About")
);
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={["admin"]} />}>
            <Route path="/admin/*" element={<AdminDashboard />}>
              ...
              <Route
                path="allteachers/view-profile/:email"
                element={<ViewTeacher />}
              />
              <Route
                path="allteachers/edit-profile/:email"
                element={<EditTeacher />}
              />
              <Route
              ...
              <Route
                path="allstudent/viewstudent/view-profile/:email"
                element={<StudentIdCardNew />}
              />
              <Route
                path="allstudent/editstudent/edit-profile/:email"
                element={<EditStudent />}
              />
              <Route
                path="allstudent/StudentFeeStatus/:email"
              ...
              <Route
                path="newregistration/:registrationNumber"
                element={<ViewReg />}
              />
              ...
              />
              <Route
                path="admission/view-admission/:email"
              ...
              <Route
                path="admission/edit-admission/:email"
              ...
              <Route
                path="classes/edit-classes/:className"
                element={<EditPrimary />}
              />
